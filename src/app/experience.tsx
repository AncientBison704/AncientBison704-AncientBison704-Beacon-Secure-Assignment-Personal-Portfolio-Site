...
const Experience = () => {
  ...
  const renderTabContent = () => {
    return (
      <div className={`workExperienceText ${animate ? 'slideInRight' : ''}`}>
        {activeTab === 'task1' && (
          <>
  ...
  return (
    <div className="workExperience">
      <h2><span className="highlight">02.</span> <span className="workExperienceText2">My Work Experience</span></h2>
      <div className="aboutMeLine2"></div>
